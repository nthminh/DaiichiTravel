...
export interface RouteFare {
  ...
  /** Deterministic doc ID: "{fromStopId}_{toStopId}" (or with date range suffix).
   *  Populated from the fare_doc_id column after fromDb() conversion. */
  fareDocId?: string;
  routeId: string;
  fromStopId: string;
  toStopId: string;
...
export interface RouteSeatFare {
  id: string;           // UUID primary key (auto-generated by Supabase)
  /** Deterministic doc ID: seatId or "seatId|startDate|endDate".
   *  Populated from the fare_doc_id column after fromDb() conversion. */
  fareDocId?: string;
  routeId: string;
